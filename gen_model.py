...
# VGG-16 기반인 DarkNet를 keras로 구현한 코드
...
# coco dataset으로 pre train된 model weights를 불러옴
weight_reader = WeightReader('yolov3.weights')
# 내부 구조는 잘 모르겠지만 직접 쌓은 layer model을 파라미터로 받는듯   ☆ 구현한 model은 weights와 shape이 동일해야함!
weight_reader.load_weights(model)
# 이렇게 생성한 모델 자체를 저장할 수 있음
# model.save('model.h5')